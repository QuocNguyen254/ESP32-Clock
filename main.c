...
#define ADD_BUT GPIO_NUM_34
#define SUB_BUT GPIO_NUM_35
//#define CUR_BUT GPIO_NUM_32
#define CHANGE_BUT GPIO_NUM_33
#define START_STOP_BUT GPIO_NUM_25
#define RESET_BUT GPIO_NUM_26
//bool gpio_value = 0;
